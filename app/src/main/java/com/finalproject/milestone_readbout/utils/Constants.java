package com.finalproject.milestone_readbout.utils;

public class Constants {
    public Constants() {
    }
    public static final String GUARDIAN_API_KEY = "d03b58c6-9d0d-4c3b-b534-242272e8efe0";
    ...
    public static final String NO_NEWS = "Sorry, no news exists!";
    ...
    public static final String ALREADY_SAVED = "Already in your saved list";
